...
const Header = () => {
  return (
    <div className="fixed top-0 left-0 w-full h-14 md:h-24 bg-gradient-to-r to-primary from-secondary border border-foreground shadow z-50">
      <div className="flex justify-between items-center py-2 px-4 md:px-8 md:py-4 md:w-10/12 md:mx-auto">
        ...
        <div className="text-white flex gap-5 md:gap-10">
          <Link href="/" className="text-sm md:text-lg">記事一覧</Link>
          <Link href="/about" className="text-sm md:text-lg">アバウト</Link>
        </div>
      </div>
    </div>
  );
